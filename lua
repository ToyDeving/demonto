...
title.Size = UDim2.new(0, 421, 0, 31)
title.Visible = true
title.Name = "Title"
title.Parent = frame
...
separator.Size = UDim2.new(0, 421, 0, 13)
...
current_room.Size = UDim2.new(0, 375, 0, 23)
...
favorite_room.Size = UDim2.new(0, 375, 0, 23)
...
gender.Size = UDim2.new(0, 375, 0, 23)
gender.Visible = true
gender.Name = "Gender"
gender.Parent = frame
...
photo_reward.Size = UDim2.new(0, 375, 0, 23)
...
visual_model.Size = UDim2.new(0, 375, 0, 23)
...
laser_visible.Size = UDim2.new(0, 375, 0, 23)
...
hunting.Size = UDim2.new(0, 375, 0, 23)
